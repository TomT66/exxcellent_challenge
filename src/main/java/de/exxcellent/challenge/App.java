...
public final class App {
    ...
    public static void main(String... args) {
        ...
        String dayWithSmallestTempSpread = wa.findValuewithMinSpread();     // Your day analysis function call …
        System.out.printf("Day with smallest temperature spread : %s%n", dayWithSmallestTempSpread);

        String teamWithSmallestGoalSpread = fa.findValuewithMinSpread(); // Your goal analysis function call …
